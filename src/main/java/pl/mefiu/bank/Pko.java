...
public final class Pko implements IBank {
    ...
    public Customer createCustomer(String firstName, String secondName, Date dateOfBirth, String signature, String pin,
        ...
        return getEntitiesFactory().createCustomer(firstName, secondName, dateOfBirth, signature, pin, city, postalCode,
                street, apartmentNumber, state, email, phoneNumber, getSession());
    }
    ...
    public CustomerEmployer createCustomerEmployer(Date expiresAt, Double salary, String city, String postalCode,
                                                   ...
                                                   String phoneNumber, String name, Customer customer) {
        return getEntitiesFactory().createCustomerEmployer(expiresAt, salary, city, postalCode, street, apartmentNumber,
                state, email, phoneNumber, name, customer, getSession());
    }

    public Pko(IBankMediator iBankMediator) {
        ...
        setReportGeneratorPath("pko.pdf");
