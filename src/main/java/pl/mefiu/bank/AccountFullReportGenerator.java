...
public final class AccountFullReportGenerator extends AccountVisitor {

    public AccountFullReportGenerator(String absolutePath) {
    ...
    public void visit(Account account) throws IOException, COSVisitorException, ParseException {
        final String header = "Full Report";
        PDDocument document;
